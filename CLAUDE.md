# CLAUDE.md — Deep Native website

Behavioral and CI/CD standards for any agent (Claude Code, Codex, human) working in this repository. Modeled on the discipline in [`tomqwu/aml_open_framework/CLAUDE.md`](https://github.com/tomqwu/aml_open_framework/blob/main/CLAUDE.md). Where the source framework's rules are Python-specific, this file translates them to a Jekyll static site.
